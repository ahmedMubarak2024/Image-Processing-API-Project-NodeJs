...
import {checkIfImageCacheNotExistCacheIt,GreetingSettings} from "./ImageBussniss"
let app = ex();
app.listen(3000, () => {
...
app.get("/api/images", function (req, res) {
 ...
 let statues :Promise<GreetingSettings>=  checkIfImageCacheNotExistCacheIt(imageName, width, height)
 statues.then((result)=>{
    if(result.state){
